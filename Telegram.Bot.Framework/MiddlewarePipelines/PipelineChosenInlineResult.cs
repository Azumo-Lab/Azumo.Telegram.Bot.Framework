...
namespace Telegram.Bot.Framework.MiddlewarePipelines
{
    ...
    /// 
    /// </summary>
    internal class PipelineChosenInlineResult : AbstractMiddlewarePipeline
    {
        public PipelineChosenInlineResult(IServiceProvider serviceProvider) : base(serviceProvider) { }
