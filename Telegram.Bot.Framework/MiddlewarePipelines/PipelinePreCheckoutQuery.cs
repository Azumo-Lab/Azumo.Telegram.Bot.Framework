...
namespace Telegram.Bot.Framework.MiddlewarePipelines
{
    ...
    /// 
    /// </summary>
    internal class PipelinePreCheckoutQuery : AbstractMiddlewarePipeline
    {
        public PipelinePreCheckoutQuery(IServiceProvider serviceProvider) : base(serviceProvider)
        {
